...
- [Task List App](https://github.com/rafael-o-cunha/App-Lista-de-Tarefas/blob/main/README.md) - Practical microproject exploring backend fundamentals with plain PHP, implementing a simple task CRUD. ![Bash](https://img.shields.io/badge/PHP-7.4-blue)  ![Bash](https://img.shields.io/badge/MySQL-5.7-blue) 
