...
### 🗂️ Acerca de:
Este espacio fue creado para organizar y facilitar el acceso a todos mis diversos proyectos y estudios *públicos*, que se dividen en categorías y pilas tecnológicas. Mi objetivo es ofrecer una visión clara y estructurada de los proyectos que he ido desarrollando, permitiendo navegar y explorar fácilmente cada uno de ellos.

### 📌  Organización
Los proyectos se organizan en diferentes categorías, en función del tipo de proyecto y de las pilas utilizadas:
<ul>
  <li>
    <strong>Web:</strong> Proyectos centrados en el desarrollo de aplicaciones web, API, etc.
  </li>
  <li>
    <strong>Desktop:</strong> Proyectos basados en desarrollo de escritorio, CLI, etc.
  </li>
  <li>
    <strong>devops:</strong> Proyectos centrados en devops, infra, cloud, CI/CD
  </li>
  <li>
